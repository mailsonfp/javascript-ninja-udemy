(function(){
    ...
    */
    console.log( '\nOperation:' );
    // ?
    var operation = justMod2Or3.reduce(function(soma, atual){
        return (soma + 1) * atual;
    },0);
    ...
    */
    console.log( '\nOperation 2:' );
    // ?
    var operation2 = justMod2Or3.reduceRight(function(soma, atual){
        return (soma + 1) * atual;
    },0);
    ...
    */
    ...
    // ?
    var myName = ['Ma','il','son'];
    var nome = myName.reduce(function(nome, item){
        nome += 'p' + item;
        return nome;
    },'');
    console.log(nome);
    ...
    */
    console.log( '\nInversed Name:' );
    // ?
    var nomeInvertido = myName.reduceRight(function(nome, item){
        return nome += item;
    });
    ...
    */
    ...
    var existe2 = numberObjects.some(function(item){
